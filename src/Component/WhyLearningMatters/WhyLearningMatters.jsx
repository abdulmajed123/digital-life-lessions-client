...
export default function WhyLearningMatters() {
  ...
  return (
    <section className="py-16 bg-linear-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-900">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800 dark:text-gray-100">
          Why Learning From Life{" "}
          <span className="text-blue-600 dark:text-blue-400">Matters</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((item, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-all rounded-2xl p-6 border border-gray-100 dark:border-gray-600"
            >
              <div className="text-4xl mb-4">{item.icon}</div>
